<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="操作时间" prop="caozuoshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.caozuoshijian" label="操作时间" prop="caozuoshijian">
					<el-input v-model="ruleForm.caozuoshijian" placeholder="操作时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="考勤类型" prop="kaoqinleixing">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="考勤类型" prop="kaoqinleixing">
					<el-input v-model="ruleForm.kaoqinleixing"
						placeholder="考勤类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="考勤备注" prop="kaoqinbeizhu">
					<el-input v-model="ruleForm.kaoqinbeizhu" placeholder="考勤备注" clearable  :readonly="ro.kaoqinbeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="考勤备注" prop="kaoqinbeizhu">
					<el-input v-model="ruleForm.kaoqinbeizhu" placeholder="考勤备注" readonly></el-input>
				</el-form-item>
