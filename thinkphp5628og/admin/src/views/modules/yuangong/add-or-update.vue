	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="部门" prop="bumen">
					<el-select :disabled="ro.bumen" v-model="ruleForm.bumen" placeholder="请选择部门" @change="(e)=>change1(e,'bumen')">
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="职位" prop="zhiwei">
