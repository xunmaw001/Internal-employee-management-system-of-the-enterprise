<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"80px 0 0","listStyle":"none","margin":"0","background":"rgba(0, 0, 0, 0)","width":"220px","position":"relative"}' class="el-menu-vertical-demo" default-active="0">
	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","background":"rgba(143, 143, 143, 0)","display":"none"}
