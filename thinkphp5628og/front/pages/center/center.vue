	...
	<view class="content">
		<view :style='{"width":"100%","padding":"0","position":"relative","background":"#fff","height":"100%"}'>
			<view :style='{"padding":"0 24rpx 8rpx","margin":"0 0 32rpx 0","background":"#e4f4ec","display":"flex","width":"100%","position":"relative","height":"300rpx"}' @tap="onPageTap('../user-info/user-info')" class="header" v-bind:class="{'status':isH5Plus}">
				<view :style='{"boxShadow":"2rpx 4rpx 8rpx #ddd","margin":"30rpx auto","alignItems":"center","borderRadius":"400rpx","background":"radial-gradient(circle, rgba(255,255,255,1) 0%, rgba(246,246,246,1) 100%)","display":"flex","width":"100%","height":"80%"}' v-if="tableName=='yuangong'" class="userinfo">
					...
					<view :style='{"margin":"0 20rpx","flex":"1","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"100%"}' class="info">
						<view :style='{"width":"100%","lineHeight":"36rpx","fontSize":"28rpx","color":"#266b51"}'>{{user.yuangonggonghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
				</view>
			...
			<view :style='{"width":"100%","padding":"0 24rpx","flexWrap":"wrap","background":"#fff","display":"flex","height":"auto"}' class="list">
				...
				<view @tap="onPageTap('../messages/list')" :style='{"borderColor":"#c9f2e4","margin":"0 0 16rpx","alignItems":"center","borderRadius":"40rpx","borderWidth":"2rpx","background":"#f3fcf9","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="li" hover-class="hover">
					...
					<view class="text" :style='{"width":"100%","padding":"0 24rpx","lineHeight":"80rpx","fontSize":"28rpx","color":"#333","flex":"1"}'>意见反馈</view>
					<view v-if="true" :style='{"width":"28rpx","margin":"0 16rpx 0 0","lineHeight":"28rpx","fontSize":"28rpx","color":"#999"}' class="cuIcon-right"></view>
				</view>
